...
public class PlayerSender extends TestCommandSender implements CommandSender, Player {
    public PlayerSender(String senderName) {
        super(senderName);
    }
    ...
    public boolean hasPermission(String s) {
        return handlePermissionCheck(s);
    }
